...
- **Table View**: Displays all evaluated buildings in rows, with sortable columns:
    ...
    - **Buildings Name, level and Era** of the building. For multiple buildings, only one era is displayed. Check [City Map](../town/README.md#main-city-side-menu) for details.
...
{% hint style="sucess" %}
Enable Only highlights while searching to narrow the list to only matching buildings.
{% endhint %}
