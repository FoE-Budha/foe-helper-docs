...
- **The alerts display area**
  ...
  - **Preview**: Displays selected notification preview
  - **Edit**: Opens [edit Alert Menu](#create-or-edit-alarm)
...
## Create or Edit Alarm

You can create a custom alarm by opening the window, inputing title, helpful description, and setting the time when notification should be triggered.

![Create Alert Menu](./.images/new-alarm-menu.png)

The Create Alerts Menu is structured as follows, from top to bottom:
- **Title** – A custom name for the alarm (displayed in Alerts Overview and as a subject of Notification)
...
- **Presets** - [Dropdown menu](#presets) with available presets for Antiques Dealer or GBG
- **Repeat** – Choose how often the alarm repeats (e.g., `never`, every `15 min`, `1h` hourly).
