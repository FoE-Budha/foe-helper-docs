...
- **Round** – Shows which round is negotiated, and how many negotiation rounds are available. If a Tavern boost is active, the assistant will recognize this and display `1/4` accordingly.
- **Preference order** – Lists the resources available for the negotiation. You can change their order manually before the first round via drag & drop.

## Settings

![Settings menu](./.images/settings-menu.png)

In the extension [settings](../settings/README.md#pop-ups-tab), you can choose whether the Negotiation Assistant should launch automatically when a negotiation starts.

## Usage

The bottom half of the dialog displays the resources suggested for negotiation.  
...
The small circles below the suggestions show the [shortcut keys](https://en.wiki.forgeofempires.com/index.php?title=Keyboard_shortcuts) you can use.  
For example, in the third column in the image above, it shows `2-5`:
- Press **2** to select the third negotiator.
- Press **5** to assign the sixth resource (e.g., Supplies).
...
**Q: Why doesn’t the Negotiation Assistant appear during Guild Battleground negotiations?**<br>
...
It remains active in other areas like Campaign Map, Expeditions, Quests, and Feudal Japan.